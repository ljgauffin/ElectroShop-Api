...
namespace ElectroShop.Migrations
{
    ...
    [Migration("20230924011847_UserPhone")]
            ...
            modelBuilder.Entity("ElectroShop.Models.Cart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 9, 23, 22, 18, 47, 145, DateTimeKind.Local).AddTicks(7817),
                        ...
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 9, 23, 22, 18, 47, 145, DateTimeKind.Local).AddTicks(8137),
                        ...
                        new
                        {
                            ...
                            DateTime = new DateTime(2023, 9, 23, 22, 18, 47, 145, DateTimeKind.Local).AddTicks(8142),
            ...
            modelBuilder.Entity("ElectroShop.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PhoneValidatedAt = new DateTime(2023, 9, 23, 22, 18, 47, 143, DateTimeKind.Local).AddTicks(1969),
                            RoleId = new Guid("b3a3096e-4274-4799-a843-380868d4844c"),
                            Surname = "Perez"
                        },
                        new
                        {
                            ...
                            PhoneValidatedAt = new DateTime(2023, 9, 23, 22, 18, 47, 145, DateTimeKind.Local).AddTicks(5843),
                            RoleId = new Guid("b3a3096e-4274-4799-a843-380868d4845c"),
                            Surname = "Gonzales"
                        },
                        new
                        {
                            ...
                            PhoneValidatedAt = new DateTime(2023, 9, 23, 22, 18, 47, 145, DateTimeKind.Local).AddTicks(5863),
                            RoleId = new Guid("b3a3096e-4274-4799-a843-380868d4846c"),
                            Surname = "Ramirez"
                        });
                });
